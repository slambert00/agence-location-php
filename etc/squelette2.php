...
<nav>
	<div class="dropdown" id="voitures">
		...
		<div id="aMasquerInsertVoiture" style="display:none;">
			<form method="post" action="insertVoiture.php">
		...
		<div id="aMasquerSupprimeVoiture" style="display:none;">
			<form method="post" action="suppriVoiture.php"> 
		...
		<div id="aMasquerPrixVoiture" style="display:none;">
			<form method="post" action="prixVoiture.php">
		...
		<div id="aMasquerAssigneVoiture" style="display:none;">
			<form method="post" action="assignVoiture.php"> 
		...
		<div id="aMasquerRendVoiture" style="display:none;">		
			<form method="post" action="rendVoiture.php"> 		
	...
	<div class="dropdown" id="motos">
		...
		<div id="aMasquerInsertmoto" style="display:none;">
			<form method="post" action="insertmoto.php">
		...
		<div id="aMasquerSupprimemoto" style="display:none;">
			<form method="post" action="supprimoto.php"> 
		...
		<div id="aMasquerPrixmoto" style="display:none;">
			<form method="post" action="prixmoto.php">
		...
		<div id="aMasquerAssignemoto" style="display:none;">
			<form method="post" action="assignmoto.php"> 
        		<label for="identifiant">identifiant du loueur</label>
        		<input type="text" id="identifiant" name="identifiant"/><br>
				<label for="prenom">prénom du loueur</label>
        		<input type="text" id="prenom" name="prenom"/><br>
		...
		<div id="aMasquerRendmoto" style="display:none;">		
			<form method="post" action="rendmoto.php"> 		
	...
	<form method="post" action="voirTous.php"><input class="Buttonstyled" type="submit" value="voir les véhicules"></form>
	<form method="post" action="voirTousLibre.php"><input class="Buttonstyled" type="submit" value="voir les véhicules libres"></form>
	<form method="post" action="voirTousLoues.php"><input class="Buttonstyled" type="submit" value="voir les véhicules loués"></form>
	</div>
</nav>
</body>
